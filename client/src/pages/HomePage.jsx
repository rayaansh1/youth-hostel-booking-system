...
export default function HomePage() {
  ...
  return (
    <div style={{ background:'#0D0D0D' }}>
      ...
      {/* FIX #1: GOVERNMENT HEADER — dark background, gold text */}
      <div style={{ background:'#0D0D0D', padding:'14px 24px', paddingTop:90, display:'flex', alignItems:'center', justifyContent:'center', gap:20, flexWrap:'wrap', borderBottom:'1px solid rgba(201,168,76,0.15)' }}>
        <img src={logoImg} alt="GOI" style={{ height:52, filter:'brightness(0) invert(1)' }} />
        <div style={{ textAlign:'center' }}>
          <div style={{ fontFamily:'DM Sans,sans-serif', fontSize:14, fontWeight:600, color:'#C9A84C' }}>युवा कार्यक्रम एवं खेल मंत्रालय</div>
          <div style={{ fontFamily:'DM Sans,sans-serif', fontSize:13, color:'rgba(255,255,255,0.6)' }}>भारत सरकार</div>
          <div style={{ fontFamily:'DM Sans,sans-serif', fontSize:14, fontWeight:700, color:'#C9A84C' }}>Ministry of Youth Affairs & Sports</div>
          <div style={{ fontFamily:'DM Sans,sans-serif', fontSize:13, fontWeight:600, color:'rgba(255,255,255,0.7)' }}>Government of India</div>
        </div>
        <img src={logoImg} alt="YHA" style={{ height:52, filter:'brightness(0) invert(1) sepia(1) saturate(3) hue-rotate(5deg)' }} />
      </div>
