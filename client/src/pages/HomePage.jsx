      ...
      <section style={{ padding:'80px 24px', background:'linear-gradient(135deg,#C9A84C 0%,#9B7D35 50%,#7A6128 100%)', textAlign:'center' }}>
        <div style={{ maxWidth:700, margin:'0 auto' }}>
          ...
          <div style={{ display:'flex', gap:16, justifyContent:'center', flexWrap:'wrap' }}>
            ...
            <a href="https://wa.me/917060563072" target="_blank" rel="noreferrer" style={{ padding:'16px 44px', background:'#25D366', color:'#FFF', borderRadius:2, fontSize:13, letterSpacing:2, textTransform:'uppercase', textDecoration:'none', fontWeight:700, fontFamily:'DM Sans,sans-serif' }}>💬 WhatsApp Us</a>
          </div>
        </div>
      </section>

      {/* Floating WhatsApp */}
      <a href="https://wa.me/917060563072" target="_blank" rel="noreferrer" className="whatsapp-float">
